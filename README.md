...
git remote add origin https://github.com/lemniskett/Dumbways.git # Tambahkan remote dengan nama origin
git commit -m "Commit message" # Commit perubahan perubahan
